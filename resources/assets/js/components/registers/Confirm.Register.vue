            ...
            <div class="questionsDiv col-xs-12">                
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <ul>
                            <li>
                                <p><b>ทำไมถึงอยากจะมาเข้าค่าย JWC และคาดหวังอะไรจากค่าย ในครั้งนี้ ? : </b> <br>{{ answer.central[0] }}</p>
                            </li>
                            <li>
                                <p><b>เว็บไซต์อะไรที่น้องอยากสร้างในอนาคต พร้อมเหตุผล : </b> <br>{{ answer.central[1] }}</p>
                            </li>
                            <li>
                                <p><b>เล่าประสบการณ์ กิจกรรมและผลงานของน้อง : </b> <br>{{ answer.central[2] }}</p>
                            </li>
                            <li>
                                <p><b>เล่าความสามารถพิเศษของน้อง : </b> <br>{{ answer.central[3] }}</p>
                            </li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <ul v-if="selectedRoleX ==='marketing'">
                            <li>
                                <p><b>สมมุติว่า ถ้าหากวันนี้น้องบังเอิญเก็บไอเท็มลับในตำนานอยู่ในถ้ำลับ ซึ่งไอเท็มนั้นยังไม่มีใครเคยพบเจอ และ ไม่รู้จักมาก่อน จงบอกชื่อไอเท็มที่น้องพบเจอและ จงตั้งราคาของไอเท็มนี้ และจะนำเสนอขายไอเท็มนี้อย่างไร ( ไม่จำกัดไอเดีย ): </b> <br>{{ answer.marketing[0] }}</p>
                            </li>
                            <li>
                                <p><b>น้องจะทำอย่างไร ถ้าน้องเป็นเจ้าของเว็บไซต์เกี่ยวกับเกมส์ นักรบที่เปิดเป็นวันแรก น้องจะมีวิธีการนำเสนอเว็บไซต์อย่างไร เพื่อที่จะดึงคนเข้าชมเว็บไซต์ พร้อมเหตุผล ( ไม่จำกัดไอเดีย ): </b> <br>{{ answer.marketing[1] }}</p>
                            </li>
                        </ul>
                        <ul v-else-if="selectedRoleX ==='content'">
                            <li>
                                <p><b>สมมุติว่ามีนักรบกำลังจะออกเดินทางไปช่วยเจ้าหญิงที่ปราสาทของบอส ซึ่งสามารถหยิบของได้เพียง 3 ชิ้นเท่านั้น น้องจะเลือกหยิบอะไรไป เพราะอะไร และจงเล่าเรื่องราวการการผจญภัยเพื่อไปช่วยเจ้าหญิงจากตัวร้าย ( ไม่จำกัดไอเดีย ): </b> <br>{{ answer.content[0] }}</p>
                            </li>
                            <li>
                                <p><b>จากเรื่องที่แต่งมา จงย่อให้เหลืออย่างน้อย 120 คำและไม่เกิน 150 คำ: </b> <br>{{ answer.content[1] }}</p>
                            </li>
                        </ul>
                        <ul v-else-if="selectedRoleX ==='design'">
                            <li>
                                <p><b>จงออกแบบนักรบในรูปแบบที่ตัวเองชื่นชอบมา 1 ตัวละคร โดยไม่จำกัดไอเดีย และ สามารถใช้โปรแกรมอะไรก็ได้ เมื่อเสร็จให้อัพโหลดไฟล์ที่บนเว็บไซต์ ด้วยนามสกุลไฟล์เป็น .png .jpg หรือ .gif ก็ได้โดยขนาดไม่เกิน 2 MB. และ จงอธิบายรูปภาพที่ได้ออกแบบมา: </b> <br>{{ answer.design[0] }}</p>
                            </li>
                            <li>
                                <p><b>จงบอกชื่อเว็บไซต์ที่น้องชื่นชอบดีไซต์มากที่สุด เพราะอะไร และน้องชอบส่วนไหนของเว็บนั้นมากที่สุด และอยากจะแก้ไข ปรับปรุงส่วนไหนมากที่สุด: </b> <br>{{ answer.design[1] }}</p>
                            </li>
                        </ul>
                    </div>
                </div>
